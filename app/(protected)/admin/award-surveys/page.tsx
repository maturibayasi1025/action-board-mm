          ...
          <CardHeader className="space-y-4">
            <div>
              ...
              <CardDescription className="mt-2">
                ...
                9–11月・表彰12月 / Q4:
                12–2月・表彰3月）に含まれる月次アンケートの指名を合算し、各バリューごとに票数の多い順に最大5名を表示します。期限内・期限後の回答を含みます。上位の寄せられたコメントは、各人の行を開いて確認できます。取得件数がDB件数と一致しない場合はランキングを出さずエラーにします。月次3件の再取得合計と差分があれば警告します。発表前に下の月次内訳と、各月の「集計を見る」を突き合わせてください。
