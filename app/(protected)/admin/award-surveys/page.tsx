          ...
          <CardHeader className="space-y-4">
            <div>
              ...
              <CardDescription className="mt-2">
                ...
                「自己評価CSV」は選択中の四半期に含まれる月の、各メンバーのバリュー別自己評価本文を出力します。「他薦（受けた評価）CSV」は被推薦者1行で票数と推薦コメントをまとめます。「他薦詳細CSV」は1推薦=1行です。「上半期まとめCSV（1Q+2Q）」は選択中の会計年度の3–8月を対象に、自己評価と受けた他薦を1ファイルにまとめます。対象月はアンケートの
                year_month で絞ります。
              </CardDescription>
            </div>
