...
import { getSurveys, getTotalUsers } from "./actions";

export const runtime = "edge";

export default async function EnpsSurveysAdminPage() {
    ...
    <div className="container mx-auto py-8 px-4">
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2">eNPSアンケート管理</h1>
          ...
          <div className="flex flex-wrap gap-2 justify-end">
            <Link href="/admin/enps-surveys/reports">
              <Button variant="default">eNPSレポート</Button>
            </Link>
                    ...
                    <Card key={survey.id}>
                      <CardContent className="pt-6">
                        <div className="flex items-start justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            <Link href={`/admin/enps-surveys/${survey.id}`}>
