...
import { MainLinkButton } from "@/components/mission/MainLinkButton";
import { YouTubeSubscribeButton } from "@/components/mission/YouTubeSubscribeButton";
  ...
  return (
    <Card>
      ...
      <CardContent>
        ...
        {/* YouTubeチャンネル登録グッジョブの場合のみ、YouTube登録ボタンを表示 */}
