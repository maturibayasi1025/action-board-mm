...
export default async function Hero() {
  ...
  return (
    <section className="relative bg-gradient-to-br from-yellow-50 via-yellow-50 to-yellow-100 overflow-hidden">
      {/* 背景グラデーションオーバーレイ */}
      <div className="absolute inset-0 bg-gradient-to-br from-yellow-100/50 via-transparent to-yellow-100/40" />
      ...
      <div className="absolute inset-0 opacity-5">
        <div
          ...
          style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23F0DC00' fill-opacity='0.4'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
          }}
        />
      </div>
      ...
      <div className="relative px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl text-gray-900 mb-4 leading-tight">
            MAISON MARC経済圏
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#F0DC00] via-[#FFE800] to-[#D4C400]">
              アクションボード
            </span>
          </h1>
