...
BEGIN
    ...
    (
      ...
      'チームみらいの政策・マニフェストについてのクイズです。全部で5問！全問正解でグッジョブ達成！',
      'QUIZ',
      2,
      2
    ),
    (
      ...
      'チームみらいクイズ（初級）に挑戦しよう',
      '/img/mission_fallback.svg',
      'チームみらいについてのクイズです。全部で4問！全問正解でグッジョブ達成！',
      'QUIZ',
      1,
      2
    ),
    ...
    (q_manifesto_2_5, category_manifesto_id, 'チームみらいのマニフェストの決め方で**誤っている**ものは？', 'チームみらいのグッジョブ・ビジョンやステップ1〜3の方向性に合致している提案だけを採択対象とする。', '改善提案は AI で自動ラベリング・要約して整理する。', '最終的な反映方針をチームでまとめる。', 'チームが作成した反映方針を、AIが一件ずつ確認し、最終的な意思決定を行う。', 4, '最終的な意思決定は、党首である安野たかひろが一件ずつ確認し行うとしている。', mission_manifesto_2_id, 5);
