// Edge Runtime互換のため、HTMLテンプレートを埋め込み
...
// Edge Runtime互換のHTMLテンプレート
const WELCOME_MAIL_TEMPLATE = `<div style="
  width: 100%;
  max-width: 600px;
  margin: 0 auto;
  padding: 24px 20px;
...
">
  <p style="text-align:center; margin-bottom: 28px;">
    <img src="https://tibsocpjqvxxipszbwui.supabase.co/storage/v1/object/public/assets//logo.png" alt="チームみらいアクションボード"
      style="width:100px;height:83px;margin:0 auto;">
  </p>
  <h2 style="text-align:center; margin-bottom: 28px;">アクションボード登録完了！</h2>
  <p style="margin-bottom: 24px;">
    <strong>「チームみらい」アクションボード</strong>にご登録いただき、誠にありがとうございます。<br />
    アクションボードは、政治活動をもっと身近に感じながら、<strong>ゲーム感覚で楽しく参加</strong>できるプラットフォームです。<br />
    ぜひ活用して、チームみらいの活動に力を貸してください。
  </p>
  <p style="margin-bottom: 24px;">
  ...
  <p>チームみらい<br /><small>※このメールは送信専用です</small></p>
...
export async function sendWelcomeMail(to: string) {
  const html = WELCOME_MAIL_TEMPLATE;
