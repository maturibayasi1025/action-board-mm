...
const envSchema = z.object({
  ...
  MCP_GOOGLE_CLIENT_ID: z.string().optional(),
  MCP_GOOGLE_CLIENT_SECRET: z.string().optional(),
  MCP_ALLOWED_GOOGLE_DOMAIN: z.string().optional(),
  MCP_ALLOWED_GOOGLE_EMAILS: z.string().optional(),
